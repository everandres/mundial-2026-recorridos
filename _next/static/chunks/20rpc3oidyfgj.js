...
`,c7={name:"arc",vs:c9,fs:c9,uniformTypes:{greatCircle:"f32",useShortestPath:"f32",numSegments:"f32",widthScale:"f32",widthMinPixels:"f32",widthMaxPixels:"f32",widthUnits:"i32"}},he=`\
#version 300 es
...
`,hi=[0,0,0,255],hr={getSourcePosition:{type:"accessor",value:e=>e.sourcePosition},getTargetPosition:{type:"accessor",value:e=>e.targetPosition},getSourceColor:{type:"accessor",value:hi},getTargetColor:{type:"accessor",value:hi},getWidth:{type:"accessor",value:1},getHeight:{type:"accessor",value:1},getTilt:{type:"accessor",value:0},greatCircle:!1,numSegments:{type:"number",value:50,min:1},widthUnits:"pixels",widthScale:{type:"number",value:1,min:0},widthMinPixels:{type:"number",value:0,min:0},widthMaxPixels:{type:"number",value:Number.MAX_SAFE_INTEGER,min:0}};class hn extends c8{getBounds(){return this.getAttributeManager()?.getBounds(["instanceSourcePositions","instanceTargetPositions"])}getShaders(){return super.getShaders({vs:he,fs:ht,modules:[iq,r8,c7]})}get wrapLongitude(){return!1}initializeState(){this.getAttributeManager().addInstanced({instanceSourcePositions:{size:3,type:"float64",fp64:this.use64bitPositions(),transition:!0,accessor:"getSourcePosition"},instanceTargetPositions:{size:3,type:"float64",fp64:this.use64bitPositions(),transition:!0,accessor:"getTargetPosition"},instanceSourceColors:{size:this.props.colorFormat.length,type:"unorm8",transition:!0,accessor:"getSourceColor",defaultValue:hi},instanceTargetColors:{size:this.props.colorFormat.length,type:"unorm8",transition:!0,accessor:"getTargetColor",defaultValue:hi},instanceWidths:{size:1,transition:!0,accessor:"getWidth",defaultValue:1},instanceHeights:{size:1,transition:!0,accessor:"getHeight",defaultValue:1},instanceTilts:{size:1,transition:!0,accessor:"getTilt",defaultValue:0}})}updateState(e){super.updateState(e),e.changeFlags.extensionsChanged&&(this.state.model?.destroy(),this.state.model=this._getModel(),this.getAttributeManager().invalidateAll())}draw({uniforms:e}){let{widthUnits:t,widthScale:i,widthMinPixels:r,widthMaxPixels:n,greatCircle:s,wrapLongitude:o,numSegments:a}=this.props,l={numSegments:a,widthUnits:iC[t],widthScale:i,widthMinPixels:r,widthMaxPixels:n,greatCircle:s,useShortestPath:o},c=this.state.model;c.shaderInputs.setProps({arc:l}),c.setVertexCount(2*a),c.draw(this.context.renderPass)}_getModel(){return new cc(this.context.device,{...this.getShaders(),id:this.props.id,bufferLayout:this.getAttributeManager().getBufferLayouts(),topology:"triangle-strip",isInstanced:!0})}}hn.layerName="ArcLayer",hn.defaultProps=hr;class hs{id;topology;vertexCount;indices;attributes;userData={};constructor(e){const{attributes:t={},indices:i=null,vertexCount:r=null}=e;for(const[r,n]of(this.id=e.id||lV("geometry"),this.topology=e.topology,i&&(this.indices=ArrayBuffer.isView(i)?{value:i,size:1}:i),this.attributes={},Object.entries(t))){const e=ArrayBuffer.isView(n)?{value:n}:n;if(!ArrayBuffer.isView(e.value))throw Error(`${this._print(r)}: must be typed array or object with value as typed array`);if("POSITION"!==r&&"positions"!==r||e.size||(e.size=3),"indices"===r){if(this.indices)throw Error("Multiple indices detected");this.indices=e}else this.attributes[r]=e}this.indices&&void 0!==this.indices.isIndexed&&(this.indices=Object.assign({},this.indices),delete this.indices.isIndexed),this.vertexCount=r||this._calculateVertexCount(this.attributes,this.indices)}getVertexCount(){return this.vertexCount}getAttributes(){return this.indices?{indices:this.indices,...this.attributes}:this.attributes}_print(e){return`Geometry ${this.id} attribute ${e}`}_setAttributes(e,t){return this}_calculateVertexCount(e,t){if(t)return t.value.length;let i=1/0;for(let t of Object.values(e)){let{value:e,size:r,constant:n}=t;!n&&e&&void 0!==r&&r>=1&&(i=Math.min(i,e.length/r))}return i}}let ho=`\
...
`,ha={name:"icon",vs:ho,fs:ho,uniformTypes:{sizeScale:"f32",iconsTextureDim:"vec2<f32>",sizeBasis:"f32",sizeMinPixels:"f32",sizeMaxPixels:"f32",billboard:"f32",sizeUnits:"i32",alphaCutoff:"f32"}},hl=`\
#version 300 es
...
`,hu=()=>{},hd={minFilter:"linear",mipmapFilter:"linear",magFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"},hp={x:0,y:0,width:0,height:0};function hf(e){return e&&(e.id||e.url)}function hg(e){let{device:t}=e;"webgl"===t.type?e.generateMipmapsWebGL():"webgpu"===t.type&&t.generateMipmapsWebGPU(e)}function hm(e,t,i){for(let r=0;r<t.length;r++){let{icon:n,xOffset:s}=t[r];e[hf(n)]={...n,x:s,y:i}}}class hv{constructor(e,{onUpdate:t=hu,onError:i=hu}){this._loadOptions=null,this._texture=null,this._externalTexture=null,this._mapping={},this._samplerParameters=null,this._pendingCount=0,this._autoPacking=!1,this._xOffset=0,this._yOffset=0,this._rowHeight=0,this._buffer=4,this._canvasWidth=1024,this._canvasHeight=0,this._canvas=null,this.device=e,this.onUpdate=t,this.onError=i}finalize(){this._texture?.delete()}getTexture(){return this._texture||this._externalTexture}getIconMapping(e){let t=this._autoPacking?hf(e):e;return this._mapping[t]||hp}setProps({loadOptions:e,autoPacking:t,iconAtlas:i,iconMapping:r,textureParameters:n}){e&&(this._loadOptions=e),void 0!==t&&(this._autoPacking=t),r&&(this._mapping=r),i&&(this._texture?.delete(),this._texture=null,this._externalTexture=i),n&&(this._samplerParameters=n)}get isLoaded(){return 0===this._pendingCount}packIcons(e,t){if(!this._autoPacking||"u"<typeof document)return;let i=Object.values(function(e,t,i){if(!e||!t)return null;i=i||{};let r={},{iterable:n,objectInfo:s}=lh(e);for(let e of n){s.index++;let n=t(e,s),o=hf(n);if(!n)throw Error("Icon is missing.");if(!n.url)throw Error("Icon url is missing.");r[o]||i[o]&&n.url===i[o].url||(r[o]={...n,source:e,sourceIndex:s.index})}return r}(e,t,this._mapping)||{});if(i.length>0){let{mapping:e,xOffset:t,yOffset:r,rowHeight:n,canvasHeight:s}=function({icons:e,buffer:t,mapping:i={},xOffset:r=0,yOffset:n=0,rowHeight:s=0,canvasWidth:o}){let a=[];for(let l=0;l<e.length;l++){let c=e[l];if(!i[hf(c)]){let{height:e,width:l}=c;r+l+t>o&&(hm(i,a,n),r=0,n=s+n+t,s=0,a=[]),a.push({icon:c,xOffset:r}),r=r+l+t,s=Math.max(s,e)}}return a.length>0&&hm(i,a,n),{mapping:i,rowHeight:s,xOffset:r,yOffset:n,canvasWidth:o,canvasHeight:Math.pow(2,Math.ceil(Math.log2(s+n+t)))}}({icons:i,buffer:this._buffer,canvasWidth:this._canvasWidth,mapping:this._mapping,rowHeight:this._rowHeight,xOffset:this._xOffset,yOffset:this._yOffset});this._rowHeight=n,this._mapping=e,this._xOffset=t,this._yOffset=r,this._canvasHeight=s,this._texture||(this._texture=this.device.createTexture({format:"rgba8unorm",data:null,width:this._canvasWidth,height:this._canvasHeight,sampler:this._samplerParameters||hd,mipLevels:this.device.getMipLevelCount(this._canvasWidth,this._canvasHeight)})),this._texture.height!==this._canvasHeight&&(this._texture=function(e,t,i,r){let{width:n,height:s,device:o}=e,a=o.createTexture({format:"rgba8unorm",width:t,height:i,sampler:r,mipLevels:o.getMipLevelCount(t,i)}),l=o.createCommandEncoder();l.copyTextureToTexture({sourceTexture:e,destinationTexture:a,width:n,height:s});let c=l.finish();return o.submit(c),hg(a),e.destroy(),a}(this._texture,this._canvasWidth,this._canvasHeight,this._samplerParameters||hd)),this.onUpdate(!0),this._canvas=this._canvas||document.createElement("canvas"),this._loadIcons(i)}}_loadIcons(e){let t=this._canvas.getContext("2d",{willReadFrequently:!0});for(let i of e)this._pendingCount++,sj(i.url,this._loadOptions).then(e=>{let r=hf(i),n=this._mapping[r],{x:s,y:o,width:a,height:l}=n,{image:c,width:h,height:u}=function(e,t,i,r){let n=Math.min(i/t.width,r/t.height),s=Math.floor(t.width*n),o=Math.floor(t.height*n);return 1===n?{image:t,width:s,height:o}:(e.canvas.height=o,e.canvas.width=s,e.clearRect(0,0,s,o),e.drawImage(t,0,0,t.width,t.height,0,0,s,o),{image:e.canvas,width:s,height:o})}(t,e,a,l),d=s+(a-h)/2,p=o+(l-u)/2;this._texture?.copyExternalImage({image:c,x:d,y:p,width:h,height:u}),n.x=d,n.y=p,n.width=h,n.height=u,this._texture&&hg(this._texture),this.onUpdate(h!==a||u!==l)}).catch(e=>{this.onError({url:i.url,source:i.source,sourceIndex:i.sourceIndex,loadOptions:this._loadOptions,error:e})}).finally(()=>{this._pendingCount--})}}let h_=[0,0,0,255],hy={iconAtlas:{type:"image",value:null,async:!0},iconMapping:{type:"object",value:{},async:!0},sizeScale:{type:"number",value:1,min:0},billboard:!0,sizeUnits:"pixels",sizeBasis:"height",sizeMinPixels:{type:"number",min:0,value:0},sizeMaxPixels:{type:"number",min:0,value:Number.MAX_SAFE_INTEGER},alphaCutoff:{type:"number",value:.05,min:0,max:1},getPosition:{type:"accessor",value:e=>e.position},getIcon:{type:"accessor",value:e=>e.icon},getColor:{type:"accessor",value:h_},getSize:{type:"accessor",value:1},getAngle:{type:"accessor",value:0},getPixelOffset:{type:"accessor",value:[0,0]},onIconError:{type:"function",value:null,optional:!0},textureParameters:{type:"object",ignore:!0,value:null}};class hb extends c8{getShaders(){return super.getShaders({vs:hl,fs:hc,source:hh,modules:[iq,tt,r8,ha]})}initializeState(){this.state={iconManager:new hv(this.context.device,{onUpdate:this._onUpdate.bind(this),onError:this._onError.bind(this)})},this.getAttributeManager().addInstanced({instancePositions:{size:3,type:"float64",fp64:this.use64bitPositions(),transition:!0,accessor:"getPosition"},instanceSizes:{size:1,transition:!0,accessor:"getSize",defaultValue:1},instanceIconDefs:{size:7,accessor:"getIcon",transform:this.getInstanceIconDef,shaderAttributes:{instanceOffsets:{size:2,elementOffset:0},instanceIconFrames:{size:4,elementOffset:2},instanceColorModes:{size:1,elementOffset:6}}},instanceColors:{size:this.props.colorFormat.length,type:"unorm8",transition:!0,accessor:"getColor",defaultValue:h_},instanceAngles:{size:1,transition:!0,accessor:"getAngle"},instancePixelOffset:{size:2,transition:!0,accessor:"getPixelOffset"}})}updateState(e){super.updateState(e);let{props:t,oldProps:i,changeFlags:r}=e,n=this.getAttributeManager(),{iconAtlas:s,iconMapping:o,data:a,getIcon:l,textureParameters:c}=t,{iconManager:h}=this.state;if("string"==typeof s)return;let u=s||this.internalState.isAsyncPropLoading("iconAtlas");h.setProps({loadOptions:t.loadOptions,autoPacking:!u,iconAtlas:s,iconMapping:u?o:null,textureParameters:c}),u?i.iconMapping!==t.iconMapping&&n.invalidate("getIcon"):(r.dataChanged||r.updateTriggersChanged&&(r.updateTriggersChanged.all||r.updateTriggersChanged.getIcon))&&h.packIcons(a,l),r.extensionsChanged&&(this.state.model?.destroy(),this.state.model=this._getModel(),n.invalidateAll())}get isLoaded(){return super.isLoaded&&this.state.iconManager.isLoaded}finalizeState(e){super.finalizeState(e),this.state.iconManager.finalize()}draw({uniforms:e}){let{sizeScale:t,sizeBasis:i,sizeMinPixels:r,sizeMaxPixels:n,sizeUnits:s,billboard:o,alphaCutoff:a}=this.props,{iconManager:l}=this.state,c=l.getTexture();if(c){let e=this.state.model,l={iconsTexture:c,iconsTextureDim:[c.width,c.height],sizeUnits:iC[s],sizeScale:t,sizeBasis:+("height"===i),sizeMinPixels:r,sizeMaxPixels:n,billboard:o,alphaCutoff:a};e.shaderInputs.setProps({icon:l}),e.draw(this.context.renderPass)}}_getModel(){return new cc(this.context.device,{...this.getShaders(),id:this.props.id,bufferLayout:this.getAttributeManager().getBufferLayouts(),geometry:new hs({topology:"triangle-strip",attributes:{positions:{size:2,value:new Float32Array([-1,-1,1,-1,-1,1,1,1])}}}),isInstanced:!0})}_onUpdate(e){e?(this.getAttributeManager()?.invalidate("getIcon"),this.setNeedsUpdate()):this.setNeedsRedraw()}_onError(e){let t=this.getCurrentLayer()?.props.onIconError;t?t(e):tU.error(e.error.message)()}getInstanceIconDef(e){let{x:t,y:i,width:r,height:n,mask:s,anchorX:o=r/2,anchorY:a=n/2}=this.state.iconManager.getIconMapping(e);return[r/2-o,n/2-a,t,i,r,n,+!!s]}}hb.defaultProps=hy,hb.layerName="IconLayer";let hw=hb,hx=`\
...
`,hP={name:"scatterplot",vs:hx,fs:hx,source:"",uniformTypes:{radiusScale:"f32",radiusMinPixels:"f32",radiusMaxPixels:"f32",lineWidthScale:"f32",lineWidthMinPixels:"f32",lineWidthMaxPixels:"f32",stroked:"f32",filled:"f32",antialiasing:"f32",billboard:"f32",radiusUnits:"i32",lineWidthUnits:"i32"}},hC=`\
#version 300 es
...
`,hS=[0,0,0,255],hL={radiusUnits:"meters",radiusScale:{type:"number",min:0,value:1},radiusMinPixels:{type:"number",min:0,value:0},radiusMaxPixels:{type:"number",min:0,value:Number.MAX_SAFE_INTEGER},lineWidthUnits:"meters",lineWidthScale:{type:"number",min:0,value:1},lineWidthMinPixels:{type:"number",min:0,value:0},lineWidthMaxPixels:{type:"number",min:0,value:Number.MAX_SAFE_INTEGER},stroked:!1,filled:!0,billboard:!1,antialiasing:!0,getPosition:{type:"accessor",value:e=>e.position},getRadius:{type:"accessor",value:1},getFillColor:{type:"accessor",value:hS},getLineColor:{type:"accessor",value:hS},getLineWidth:{type:"accessor",value:1},getPixelOffset:{type:"accessor",value:[0,0]},strokeWidth:{deprecatedFor:"getLineWidth"},outline:{deprecatedFor:"stroked"},getColor:{deprecatedFor:["getFillColor","getLineColor"]}};class hA extends c8{getShaders(){return super.getShaders({vs:hC,fs:hM,source:hE,modules:[iq,tt,r8,hP]})}initializeState(){this.getAttributeManager().addInstanced({instancePositions:{size:3,type:"float64",fp64:this.use64bitPositions(),transition:!0,accessor:"getPosition"},instanceRadius:{size:1,transition:!0,accessor:"getRadius",defaultValue:1},instanceFillColors:{size:this.props.colorFormat.length,transition:!0,type:"unorm8",accessor:"getFillColor",defaultValue:[0,0,0,255]},instanceLineColors:{size:this.props.colorFormat.length,transition:!0,type:"unorm8",accessor:"getLineColor",defaultValue:[0,0,0,255]},instanceLineWidths:{size:1,transition:!0,accessor:"getLineWidth",defaultValue:1},instancePixelOffset:{size:2,transition:!0,accessor:"getPixelOffset"}})}updateState(e){super.updateState(e),e.changeFlags.extensionsChanged&&(this.state.model?.destroy(),this.state.model=this._getModel(),this.getAttributeManager().invalidateAll())}draw({uniforms:e}){let{radiusUnits:t,radiusScale:i,radiusMinPixels:r,radiusMaxPixels:n,stroked:s,filled:o,billboard:a,antialiasing:l,lineWidthUnits:c,lineWidthScale:h,lineWidthMinPixels:u,lineWidthMaxPixels:d}=this.props,p={stroked:s,filled:o,billboard:a,antialiasing:l,radiusUnits:iC[t],radiusScale:i,radiusMinPixels:r,radiusMaxPixels:n,lineWidthUnits:iC[c],lineWidthScale:h,lineWidthMinPixels:u,lineWidthMaxPixels:d},f=this.state.model;f.shaderInputs.setProps({scatterplot:p}),f.draw(this.context.renderPass)}_getModel(){return new cc(this.context.device,{...this.getShaders(),id:this.props.id,bufferLayout:this.getAttributeManager().getBufferLayouts(),geometry:new hs({topology:"triangle-strip",attributes:{positions:{size:3,value:new Float32Array([-1,-1,0,1,-1,0,-1,1,0,1,1,0])}}}),isInstanced:!0})}}hA.defaultProps=hL,hA.layerName="ScatterplotLayer";class hT extends c8{get isComposite(){return!0}get isDrawable(){return!1}get isLoaded(){return super.isLoaded&&this.getSubLayers().every(e=>e.isLoaded)}getSubLayers(){return this.internalState&&this.internalState.subLayers||[]}initializeState(e){}setState(e){super.setState(e),this.setNeedsUpdate()}getPickingInfo({info:e}){let{object:t}=e;return t&&t.__source&&t.__source.parent&&t.__source.parent.id===this.id&&(e.object=t.__source.object,e.index=t.__source.index),e}filterSubLayer(e){return!0}shouldRenderSubLayer(e,t){return t&&t.length}getSubLayerClass(e,t){let{_subLayerProps:i}=this.props;return i&&i[e]&&i[e].type||t}getSubLayerRow(e,t,i){return e.__source={parent:this,object:t,index:i},e}getSubLayerAccessor(e){if("function"==typeof e){let t={index:-1,data:this.props.data,target:[]};return(i,r)=>i&&i.__source?(t.index=i.__source.index,e(i.__source.object,t)):e(i,r)}return e}getSubLayerProps(e={}){let{opacity:t,pickable:i,visible:r,parameters:n,getPolygonOffset:s,highlightedObjectIndex:o,autoHighlight:a,highlightColor:l,coordinateSystem:c,coordinateOrigin:h,wrapLongitude:u,positionFormat:d,modelMatrix:p,extensions:f,fetch:g,operation:m,_subLayerProps:v}=this.props,_={id:"",updateTriggers:{},opacity:t,pickable:i,visible:r,parameters:n,getPolygonOffset:s,highlightedObjectIndex:o,autoHighlight:a,highlightColor:l,coordinateSystem:c,coordinateOrigin:h,wrapLongitude:u,positionFormat:d,modelMatrix:p,extensions:f,fetch:g,operation:m},y=v&&e.id&&v[e.id],b=y&&y.updateTriggers,w=e.id||"sublayer";if(y){let t=this.props[ni],i=e.type?e.type._propTypes:{};for(let e in y){let r=i[e]||t[e];r&&"accessor"===r.type&&(y[e]=this.getSubLayerAccessor(y[e]))}}for(let t of(Object.assign(_,e,y),_.id=`${this.props.id}-${w}`,_.updateTriggers={all:this.props.updateTriggers?.all,...e.updateTriggers,...b},f)){let e=t.getSubLayerProps.call(this,t);e&&Object.assign(_,e,{updateTriggers:Object.assign(_.updateTriggers,e.updateTriggers)})}return _}_updateAutoHighlight(e){for(let t of this.getSubLayers())t.updateAutoHighlight(e)}_getAttributeManager(){return null}_postUpdate(e,t){let i=this.internalState.subLayers,r=!i||this.needsUpdate();for(let e of(r&&(i=nu(this.renderLayers(),Boolean),this.internalState.subLayers=i),nh("compositeLayer.renderLayers",this,r,i),i))e.parent=this}}hT.layerName="CompositeLayer";let hR=hT,hO=`\
...
`,hk={name:"sdf",vs:hO,fs:hO,uniformTypes:{gamma:"f32",enabled:"f32",buffer:"f32",outlineBuffer:"f32",outlineColor:"vec4<f32>"}},hI={none:0,start:1,center:2,end:3},hz={name:"text",vs:`\
...
#define ALIGN_MODE_START ${hI.start}
#define ALIGN_MODE_CENTER ${hI.center}
#define ALIGN_MODE_END ${hI.end}
`,getUniforms:({contentCutoffPixels:e=[0,0],contentAlignHorizontal:t="none",contentAlignVertical:i="none",fontSize:r,viewport:n})=>({cutoffPixels:e,align:[hI[t],hI[i]],fontSize:r,flipY:n?.flipY??!1}),uniformTypes:{cutoffPixels:"vec2<f32>",align:"vec2<i32>",fontSize:"f32",flipY:"f32"}},hj=`\
#version 300 es
...
`;class hF extends hw{getShaders(){let e=super.getShaders();return{...e,modules:[...e.modules,hz,hk],vs:hj,fs:hD}}initializeState(){super.initializeState();let e=this.getAttributeManager();e.attributes.instanceIconDefs.settings.update=this.calculateInstanceIconDefs,e.addInstanced({instancePickingColors:{type:"uint8",size:4,accessor:(e,{index:t,target:i})=>this.encodePickingColor(t,i)},instanceClipRect:{size:4,accessor:"getContentBox",defaultValue:[0,0,-1,-1]}})}updateState(e){super.updateState(e);let{props:t,oldProps:i,changeFlags:r}=e,{outlineColor:n}=t;if(r.updateTriggersChanged&&(r.updateTriggersChanged.getIcon||r.updateTriggersChanged.getIconOffsets)&&this.getAttributeManager().invalidate("instanceIconDefs"),n!==i.outlineColor){let e=[n[0]/255,n[1]/255,n[2]/255,(n[3]??255)/255];this.setState({outlineColor:e})}!t.sdf&&t.outlineWidth&&tU.warn(`${this.id}: fontSettings.sdf is required to render outline`)()}draw(e){let{sdf:t,smoothing:i,fontSize:r,outlineWidth:n,contentCutoffPixels:s,contentAlignHorizontal:o,contentAlignVertical:a}=this.props,{outlineColor:l}=this.state,c=n?Math.max(i,.75*(1-n)):-1,h=this.state.model,u={buffer:.75,outlineBuffer:c,gamma:i,enabled:!!t,outlineColor:l},d={contentCutoffPixels:s,contentAlignHorizontal:o,contentAlignVertical:a,fontSize:r,viewport:this.context.viewport};if(h.shaderInputs.setProps({sdf:u,text:d}),super.draw(e),t&&n){let{iconManager:e}=this.state;e.getTexture()&&(h.shaderInputs.setProps({sdf:{...u,outlineBuffer:.75}}),h.draw(this.context.renderPass))}}calculateInstanceIconDefs(e,{startRow:t,endRow:i}){let{data:r,getIcon:n,getIconOffsets:s}=this.props,o=e.getVertexOffset(t),a=e.value,{iterable:l,objectInfo:c}=lh(r,t,i);for(let t of l){c.index++;let i=n(t,c),r=s(t,c);if(i){let t=0;for(let n of Array.from(i)){let i=super.getInstanceIconDef(n);i[0]=r[2*t],i[1]+=r[2*t+1],i[6]=1,a.set(i,o),o+=e.size,t++}}}}}hF.defaultProps={getIconOffsets:{type:"accessor",value:e=>e.offsets},getContentBox:{type:"accessor",value:[0,0,-1,-1]},fontSize:1,alphaCutoff:.001,smoothing:.1,outlineWidth:0,outlineColor:{type:"color",value:[0,0,0,255]},contentCutoffPixels:{type:"array",value:[0,0]},contentAlignHorizontal:"none",contentAlignVertical:"none"},hF.layerName="MultiIconLayer";let hN=new Float64Array(256);for(let e=0;e<256;e++){let t=.5-Math.pow(e/255,1/2.2);hN[e]=t*Math.abs(t)}hN[255]=-1e20;class hU{constructor({fontSize:e=24,buffer:t=3,radius:i=8,cutoff:r=.25,fontFamily:n="sans-serif",fontWeight:s="normal",fontStyle:o="normal",lang:a=null}={}){this.buffer=t,this.radius=i,this.cutoff=r,this.lang=a;const l=this.size=e+4*t,c=this._createCanvas(l),h=this.ctx=c.getContext("2d",{willReadFrequently:!0});h.font=`${o} ${s} ${e}px ${n}`,h.textBaseline="alphabetic",h.textAlign="left",h.fillStyle="black",this.gridOuter=new Float64Array(l*l),this.gridInner=new Float64Array(l*l),this.f=new Float64Array(l),this.z=new Float64Array(l+1),this.v=new Uint16Array(l)}_createCanvas(e){if("u">typeof OffscreenCanvas)return new OffscreenCanvas(e,e);let t=document.createElement("canvas");return t.width=t.height=e,t}draw(e){let{width:t,actualBoundingBoxAscent:i,actualBoundingBoxDescent:r,actualBoundingBoxLeft:n,actualBoundingBoxRight:s}=this.ctx.measureText(e),o=Math.ceil(i),a=Math.floor(-n),l=Math.max(0,Math.min(this.size-this.buffer,Math.ceil(s)-a)),c=Math.max(0,Math.min(this.size-this.buffer,o+Math.ceil(r))),h=l+2*this.buffer,u=c+2*this.buffer,d=Math.max(h*u,0),p=new Uint8ClampedArray(d),f={data:p,width:h,height:u,glyphWidth:l,glyphHeight:c,glyphTop:o,glyphLeft:a,glyphAdvance:t};if(0===l||0===c)return f;let{ctx:g,buffer:m,gridInner:v,gridOuter:_}=this;this.lang&&(g.lang=this.lang),g.clearRect(m,m,l,c),g.fillText(e,m-a,m+o);let y=g.getImageData(m,m,l,c);_.fill(1e20,0,d),v.fill(0,0,d);let b=3;for(let e=0;e<c;e++){let t=(e+m)*h+m;for(let e=0;e<l;e++,b+=4,t++){let e=y.data[b];if(0===e)continue;let i=hN[e];_[t]=Math.max(0,i),v[t]=Math.max(0,-i)}}hB(_,0,0,h,u,h,this.f,this.v,this.z);let w=Math.min(m,1);hB(v,m-w,m-w,l+2*w,c+2*w,h,this.f,this.v,this.z);let x=255/this.radius,P=255*(1-this.cutoff);for(let e=0;e<d;e++){let t=Math.sqrt(_[e])-Math.sqrt(v[e]);p[e]=Math.round(P-x*t)}return f}}function hB(e,t,i,r,n,s,o,a,l){for(let c=t;c<t+r;c++)h$(e,i*s+c,s,n,o,a,l);for(let c=i;c<i+n;c++)h$(e,c*s+t,1,r,o,a,l)}function h$(e,t,i,r,n,s,o){s[0]=0,o[0]=-1e20,o[1]=1e20,n[0]=e[t];for(let a=1,l=0,c=0;a<r;a++){n[a]=e[t+a*i];let r=a*a;do{let e=s[l];c=(n[a]-n[e]+r-e*e)/(a-e)/2}while(c<=o[l]&&--l>-1)s[++l]=a,o[l]=c,o[l+1]=1e20}for(let a=0,l=0;a<r;a++){for(;o[l+1]<a;)l++;let r=s[l],c=a-r;e[t+a*i]=n[r]+c*c}}let hV=[];function hW(e,t,i,r){let n=0;for(let s=t;s<i;s++){let t=e[s];n+=r[t]?.advance||0}return n}function hG(e,t,i,r,n,s){let o=t,a=0;for(let l=t;l<i;l++){let t=hW(e,l,l+1,n);a+t>r&&(o<l&&s.push(l),o=l,a=0),a+=t}return a}class hH{constructor(e=5){this._cache={},this._order=[],this.limit=e}get(e){let t=this._cache[e];return t&&(this._deleteOrder(e),this._appendOrder(e)),t}set(e,t){this._cache[e]?this.delete(e):Object.keys(this._cache).length===this.limit&&this.delete(this._order[0]),this._cache[e]=t,this._appendOrder(e)}delete(e){this._cache[e]&&(delete this._cache[e],this._deleteOrder(e))}_deleteOrder(e){let t=this._order.indexOf(e);t>=0&&this._order.splice(t,1)}_appendOrder(e){this._order.push(e)}}let hq={fontFamily:"Monaco, monospace",fontWeight:"normal",characterSet:function(){let e=[];for(let t=32;t<128;t++)e.push(String.fromCharCode(t));return e}(),fontSize:64,buffer:4,sdf:!1,cutoff:.25,radius:12,smoothing:.1},hZ=new hH(3);function hY(e,t,i,r){e.font=`${r} ${i}px ${t}`,e.fillStyle="#000",e.textBaseline="alphabetic",e.textAlign="left"}class hK{constructor(){this.props={...hq}}get atlas(){return this._atlas}get mapping(){return this._atlas&&this._atlas.mapping}setProps(e={}){Object.assign(this.props,e),e._getFontRenderer&&(this._getFontRenderer=e._getFontRenderer),this._key=this._getKey();let t=function(e,t){let i;i=new Set("string"==typeof t?Array.from(t):t);let r=hZ.get(e);if(!r)return i;for(let e in r.mapping)i.has(e)&&i.delete(e);return i}(this._key,this.props.characterSet),i=hZ.get(this._key);if(i&&0===t.size){this._atlas!==i&&(this._atlas=i);return}let r=this._generateFontAtlas(t,i);this._atlas=r,hZ.set(this._key,r)}_generateFontAtlas(e,t){let i,{fontFamily:r,fontWeight:n,fontSize:s,buffer:o,sdf:a,radius:l,cutoff:c}=this.props,h=t&&t.data;h||((h=document.createElement("canvas")).width=1024);let u=h.getContext("2d",{willReadFrequently:!0});hY(u,r,s,n);let d=e=>(function(e,t,i){if(void 0===i){let i=e.measureText("A");return i.fontBoundingBoxAscent?{advance:0,width:0,ascent:Math.ceil(i.fontBoundingBoxAscent),descent:Math.ceil(i.fontBoundingBoxDescent)}:{advance:0,width:0,ascent:.9*t,descent:.3*t}}let r=e.measureText(i);return r.actualBoundingBoxAscent?{advance:r.width,width:Math.ceil(r.actualBoundingBoxRight-r.actualBoundingBoxLeft),ascent:Math.ceil(r.actualBoundingBoxAscent),descent:Math.ceil(r.actualBoundingBoxDescent)}:{advance:r.width,width:r.width,ascent:.9*t,descent:.3*t}})(u,s,e);this._getFontRenderer?i=this._getFontRenderer(this.props):a&&(i={measure:d,draw:function({fontSize:e,buffer:t,radius:i,cutoff:r,fontFamily:n,fontWeight:s}){let o=new hU({fontSize:e,buffer:t,radius:i,cutoff:r,fontFamily:n,fontWeight:`${s}`});return e=>{let{data:i,width:r,height:n}=o.draw(e),s=new ImageData(r,n);for(let e=0;e<i.length;e++)s.data[4*e+3]=i[e];return{data:s,left:t,top:t}}}(this.props)});let{mapping:p,canvasHeight:f,xOffset:g,yOffsetMin:m,yOffsetMax:v}=function({characterSet:e,measureText:t,buffer:i,maxCanvasWidth:r,mapping:n={},xOffset:s=0,yOffsetMin:o=0,yOffsetMax:a=0}){let l=s,c=o,h=a;for(let s of e)if(!n[s]){let{advance:e,width:o,ascent:a,descent:u}=t(s),d=a+u;l+o+2*i>r&&(l=0,c=h),n[s]={x:l+i,y:c+i,width:o,height:d,advance:e,anchorX:o/2,anchorY:a},l+=o+2*i,h=Math.max(h,c+d+2*i)}return{mapping:n,xOffset:l,yOffsetMin:c,yOffsetMax:h,canvasHeight:Math.pow(2,Math.ceil(Math.log2(h)))}}({measureText:e=>i?i.measure(e):d(e),buffer:o,characterSet:e,maxCanvasWidth:1024,...t&&{mapping:t.mapping,xOffset:t.xOffset,yOffsetMin:t.yOffsetMin,yOffsetMax:t.yOffsetMax}});if(h.height!==f){let e=h.height>0?u.getImageData(0,0,h.width,h.height):null;h.height=f,e&&u.putImageData(e,0,0)}if(hY(u,r,s,n),i)for(let t of e){let e=p[t],{data:r,left:n=0,top:s=0}=i.draw(t),o=e.x-n,a=e.y-s,l=Math.max(0,Math.round(o)),c=Math.max(0,Math.round(a)),d=Math.min(r.width,h.width-l),f=Math.min(r.height,h.height-c);u.putImageData(r,l,c,0,0,d,f),e.x+=l-o,e.y+=c-a}else for(let t of e){let e=p[t];u.fillText(t,e.x,e.y+e.anchorY)}let _=i?i.measure():d();return{baselineOffset:(_.ascent-_.descent)/2,xOffset:g,yOffsetMin:m,yOffsetMax:v,mapping:p,data:h,width:h.width,height:h.height}}_getKey(){let{fontFamily:e,fontWeight:t,fontSize:i,buffer:r,sdf:n,radius:s,cutoff:o}=this.props;return n?`${e} ${t} ${i} ${r} ${s} ${o}`:`${e} ${t} ${i} ${r}`}}let hX=`\
...
`,hJ={name:"textBackground",vs:hX,fs:hX,uniformTypes:{billboard:"f32",sizeScale:"f32",sizeMinPixels:"f32",sizeMaxPixels:"f32",borderRadius:"vec4<f32>",padding:"vec4<f32>",sizeUnits:"i32",stroked:"f32"}},hQ=`\
#version 300 es
...
`,h1={billboard:!0,sizeScale:1,sizeUnits:"pixels",sizeMinPixels:0,sizeMaxPixels:Number.MAX_SAFE_INTEGER,fontSize:1,borderRadius:{type:"object",value:0},padding:{type:"array",value:[0,0,0,0]},getPosition:{type:"accessor",value:e=>e.position},getSize:{type:"accessor",value:1},getAngle:{type:"accessor",value:0},getPixelOffset:{type:"accessor",value:[0,0]},getBoundingRect:{type:"accessor",value:[0,0,0,0]},getClipRect:{type:"accessor",value:[0,0,-1,-1]},getFillColor:{type:"accessor",value:[0,0,0,255]},getLineColor:{type:"accessor",value:[0,0,0,255]},getLineWidth:{type:"accessor",value:1}};class h2 extends c8{getShaders(){return super.getShaders({vs:hQ,fs:h0,modules:[iq,r8,hJ,hz]})}initializeState(){this.getAttributeManager().addInstanced({instancePositions:{size:3,type:"float64",fp64:this.use64bitPositions(),transition:!0,accessor:"getPosition"},instanceSizes:{size:1,transition:!0,accessor:"getSize",defaultValue:1},instanceAngles:{size:1,transition:!0,accessor:"getAngle"},instanceRects:{size:4,accessor:"getBoundingRect"},instanceClipRect:{size:4,accessor:"getClipRect",defaultValue:[0,0,-1,-1]},instancePixelOffsets:{size:2,transition:!0,accessor:"getPixelOffset"},instanceFillColors:{size:4,transition:!0,type:"unorm8",accessor:"getFillColor",defaultValue:[0,0,0,255]},instanceLineColors:{size:4,transition:!0,type:"unorm8",accessor:"getLineColor",defaultValue:[0,0,0,255]},instanceLineWidths:{size:1,transition:!0,accessor:"getLineWidth",defaultValue:1}})}updateState(e){super.updateState(e);let{changeFlags:t}=e;t.extensionsChanged&&(this.state.model?.destroy(),this.state.model=this._getModel(),this.getAttributeManager().invalidateAll())}draw({uniforms:e}){let{billboard:t,sizeScale:i,sizeUnits:r,sizeMinPixels:n,sizeMaxPixels:s,getLineWidth:o,fontSize:a}=this.props,{padding:l,borderRadius:c}=this.props;l.length<4&&(l=[l[0],l[1],l[0],l[1]]),Array.isArray(c)||(c=[c,c,c,c]);let h=this.state.model,u={billboard:t,stroked:!!o,borderRadius:c,padding:l,sizeUnits:iC[r],sizeScale:i,sizeMinPixels:n,sizeMaxPixels:s},d={fontSize:a,viewport:this.context.viewport};h.shaderInputs.setProps({textBackground:u,text:d}),h.draw(this.context.renderPass)}_getModel(){return new cc(this.context.device,{...this.getShaders(),id:this.props.id,bufferLayout:this.getAttributeManager().getBufferLayouts(),geometry:new hs({topology:"triangle-strip",vertexCount:4,attributes:{positions:{size:2,value:new Float32Array([0,0,1,0,0,1,1,1])}}}),isInstanced:!0})}}h2.defaultProps=h1,h2.layerName="TextBackgroundLayer";let h3={start:1,middle:0,end:-1},h4={top:1,center:0,bottom:-1},h6=[0,0,0,255],h5={billboard:!0,sizeScale:1,sizeUnits:"pixels",sizeMinPixels:0,sizeMaxPixels:Number.MAX_SAFE_INTEGER,background:!1,getBackgroundColor:{type:"accessor",value:[255,255,255,255]},getBorderColor:{type:"accessor",value:h6},getBorderWidth:{type:"accessor",value:0},backgroundBorderRadius:{type:"object",value:0},backgroundPadding:{type:"array",value:[0,0,0,0]},characterSet:{type:"object",value:hq.characterSet},fontFamily:hq.fontFamily,fontWeight:hq.fontWeight,lineHeight:1,outlineWidth:{type:"number",value:0,min:0},outlineColor:{type:"color",value:h6},fontSettings:{type:"object",value:{},compare:1},wordBreak:"break-word",maxWidth:{type:"number",value:-1},contentCutoffPixels:{type:"array",value:[0,0]},contentAlignHorizontal:"none",contentAlignVertical:"none",getText:{type:"accessor",value:e=>e.text},getPosition:{type:"accessor",value:e=>e.position},getColor:{type:"accessor",value:h6},getSize:{type:"accessor",value:32},getAngle:{type:"accessor",value:0},getTextAnchor:{type:"accessor",value:"middle"},getAlignmentBaseline:{type:"accessor",value:"center"},getPixelOffset:{type:"accessor",value:[0,0]},getContentBox:{type:"accessor",value:[0,0,-1,-1]},backgroundColor:{deprecatedFor:["background","getBackgroundColor"]}};class h8 extends hR{constructor(){super(...arguments),this.getBoundingRect=(e,t)=>{let{size:[i,r]}=this.transformParagraph(e,t),{getTextAnchor:n,getAlignmentBaseline:s}=this.props;return[(h3["function"==typeof n?n(e,t):n]-1)*i/2,(h4["function"==typeof s?s(e,t):s]-1)*r/2,i,r]},this.getIconOffsets=(e,t)=>{let{getTextAnchor:i,getAlignmentBaseline:r}=this.props,{x:n,y:s,rowWidth:o,size:[,a]}=this.transformParagraph(e,t),l=h3["function"==typeof i?i(e,t):i],c=h4["function"==typeof r?r(e,t):r],h=n.length,u=Array(2*h),d=0;for(let e=0;e<h;e++)u[d++]=(l-1)*o[e]/2+n[e],u[d++]=(c-1)*a/2+s[e];return u}}initializeState(){this.state={styleVersion:0,fontAtlasManager:new hK},this.props.maxWidth>0&&tU.once(1,"v8.9 breaking change: TextLayer maxWidth is now relative to text size")()}updateState(e){let{props:t,oldProps:i,changeFlags:r}=e;(r.dataChanged||r.updateTriggersChanged&&(r.updateTriggersChanged.all||r.updateTriggersChanged.getText))&&this._updateText(),(this._updateFontAtlas()||t.lineHeight!==i.lineHeight||t.wordBreak!==i.wordBreak||t.maxWidth!==i.maxWidth)&&this.setState({styleVersion:this.state.styleVersion+1})}getPickingInfo({info:e}){return e.object=e.index>=0?this.props.data[e.index]:null,e}_updateFontAtlas(){let{fontSettings:e,fontFamily:t,fontWeight:i,_getFontRenderer:r}=this.props,{fontAtlasManager:n,characterSet:s}=this.state,o={...e,characterSet:s,fontFamily:t,fontWeight:i,_getFontRenderer:r};if(!n.mapping)return n.setProps(o),!0;for(let e in o)if(o[e]!==n.props[e])return n.setProps(o),!0;return!1}_updateText(){let e,{data:t,characterSet:i}=this.props,r=t.attributes?.getText,{getText:n}=this.props,s=t.startIndices,o="auto"===i&&new Set;if(r&&s){let{texts:i,characterCount:a}=function({value:e,length:t,stride:i,offset:r,startIndices:n,characterSet:s}){let o=e.BYTES_PER_ELEMENT,a=i?i/o:1,l=r?r/o:0,c=n[t]||Math.ceil((e.length-l)/a),h=s&&new Set,u=Array(t),d=e;if(a>1||l>0){d=new e.constructor(c);for(let t=0;t<c;t++)d[t]=e[t*a+l]}for(let e=0;e<t;e++){let t=n[e],i=n[e+1]||c,r=d.subarray(t,i);u[e]=String.fromCodePoint.apply(null,r),h&&r.forEach(h.add,h)}if(h)for(let e of h)s.add(String.fromCodePoint(e));return{texts:u,characterCount:c}}({...ArrayBuffer.isView(r)?{value:r}:r,length:t.length,startIndices:s,characterSet:o});e=a,n=(e,{index:t})=>i[t]}else{let{iterable:i,objectInfo:r}=lh(t);for(let t of(s=[0],e=0,i)){r.index++;let i=Array.from(n(t,r)||"");o&&i.forEach(o.add,o),e+=i.length,s.push(e)}}this.setState({getText:n,startIndices:s,numInstances:e,characterSet:o||i})}transformParagraph(e,t){let{fontAtlasManager:i}=this.state,r=i.mapping,{baselineOffset:n}=i.atlas,{fontSize:s}=i.props,o=this.state.getText,{wordBreak:a,lineHeight:l,maxWidth:c}=this.props;return function(e,t,i,r,n,s){let o=Array.from(e),a=o.length,l=Array(a),c=Array(a),h=Array(a),u=("break-word"===r||"break-all"===r)&&isFinite(n)&&n>0,d=[0,0],p=[0,0],f=0,g=t+i/2,m=0,v=0;for(let e=0;e<=a;e++){let t=o[e];if(("\n"===t||e===a)&&(v=e),v>m){let e=u?function(e,t,i,r,n=0,s){void 0===s&&(s=e.length);let o=[];return"break-all"===t?hG(e,n,s,i,r,o):!function(e,t,i,r,n,s){let o=t,a=t,l=t,c=0;for(let h=t;h<i;h++)if(" "===e[h]?l=h+1:(" "===e[h+1]||h+1===i)&&(l=h+1),l>a){let t=hW(e,a,l,n);c+t>r&&(o<a&&(s.push(a),o=a,c=0),t>r&&(t=hG(e,a,l,r,n,s),o=s[s.length-1])),a=l,c+=t}}(e,n,s,i,r,o),o}(o,r,n,s,m,v):hV;for(let t=0;t<=e.length;t++){let r=0===t?m:e[t-1],n=t<e.length?e[t]:v;!function(e,t,i,r,n,s){let o=0,a=0;for(let n=t;n<i;n++){let t=r[e[n]];t&&(a=Math.max(a,t.height))}for(let s=t;s<i;s++){let t=e[s],i=r[t];i?(n[s]=o+i.anchorX,o+=i.advance):(tU.warn(`Missing character: ${t} (${t.codePointAt(0)})`)(),n[s]=o,o+=32)}s[0]=o,s[1]=a}(o,r,n,s,l,p);for(let e=r;e<n;e++)c[e]=g,h[e]=p[0];f++,g+=i,d[0]=Math.max(d[0],p[0])}m=v}"\n"===t&&(l[m]=0,c[m]=0,h[m]=0,m++)}return d[1]=f*i,{x:l,y:c,rowWidth:h,size:d}}(o(e,t)||"",n,l*s,a,c*s,r)}renderLayers(){let{startIndices:e,numInstances:t,getText:i,fontAtlasManager:{atlas:r,mapping:n},styleVersion:s}=this.state,{data:o,_dataDiff:a,getPosition:l,getColor:c,getSize:h,getAngle:u,getPixelOffset:d,getBackgroundColor:p,getBorderColor:f,getBorderWidth:g,getContentBox:m,backgroundBorderRadius:v,backgroundPadding:_,background:y,billboard:b,fontSettings:w,outlineWidth:x,outlineColor:P,sizeScale:C,sizeUnits:M,sizeMinPixels:E,sizeMaxPixels:S,contentCutoffPixels:L,contentAlignHorizontal:A,contentAlignVertical:T,transitions:R,updateTriggers:O}=this.props,k=this.getSubLayerClass("characters",hF),I=this.getSubLayerClass("background",h2),{fontSize:z}=this.state.fontAtlasManager.props;return[y&&new I({getFillColor:p,getLineColor:f,getLineWidth:g,borderRadius:v,padding:_,getPosition:l,getSize:h,getAngle:u,getPixelOffset:d,getClipRect:m,billboard:b,sizeScale:C,sizeUnits:M,sizeMinPixels:E,sizeMaxPixels:S,fontSize:z,transitions:R&&{getPosition:R.getPosition,getAngle:R.getAngle,getSize:R.getSize,getFillColor:R.getBackgroundColor,getLineColor:R.getBorderColor,getLineWidth:R.getBorderWidth,getPixelOffset:R.getPixelOffset}},this.getSubLayerProps({id:"background",updateTriggers:{getPosition:O.getPosition,getAngle:O.getAngle,getSize:O.getSize,getFillColor:O.getBackgroundColor,getLineColor:O.getBorderColor,getLineWidth:O.getBorderWidth,getPixelOffset:O.getPixelOffset,getBoundingRect:{getText:O.getText,getTextAnchor:O.getTextAnchor,getAlignmentBaseline:O.getAlignmentBaseline,styleVersion:s}}}),{data:o.attributes&&o.attributes.background?{length:o.length,attributes:o.attributes.background}:o,_dataDiff:a,autoHighlight:!1,getBoundingRect:this.getBoundingRect}),new k({sdf:w.sdf,smoothing:Number.isFinite(w.smoothing)?w.smoothing:hq.smoothing,outlineWidth:x/(w.radius||hq.radius),outlineColor:P,iconAtlas:r,iconMapping:n,getPosition:l,getColor:c,getSize:h,getAngle:u,getPixelOffset:d,getContentBox:m,billboard:b,sizeScale:C,sizeUnits:M,sizeMinPixels:E,sizeMaxPixels:S,fontSize:z,contentCutoffPixels:L,contentAlignHorizontal:A,contentAlignVertical:T,transitions:R&&{getPosition:R.getPosition,getAngle:R.getAngle,getColor:R.getColor,getSize:R.getSize,getPixelOffset:R.getPixelOffset,getContentBox:R.getContentBox}},this.getSubLayerProps({id:"characters",updateTriggers:{all:O.getText,getPosition:O.getPosition,getAngle:O.getAngle,getColor:O.getColor,getSize:O.getSize,getPixelOffset:O.getPixelOffset,getContentBox:O.getContentBox,getIconOffsets:{getTextAnchor:O.getTextAnchor,getAlignmentBaseline:O.getAlignmentBaseline,styleVersion:s}}}),{data:o,_dataDiff:a,startIndices:e,numInstances:t,getIconOffsets:this.getIconOffsets,getIcon:i})]}static set fontAtlasCacheLimit(e){tU.assert(Number.isFinite(e)&&e>=3,"Invalid cache limit"),hZ=new hH(e)}}function h9(e,t=.78){let i,[r,n,s]=[parseInt((i=e.replace("#","")).slice(0,2),16),parseInt(i.slice(2,4),16),parseInt(i.slice(4,6),16)];return[Math.round(r*t),Math.round(n*t),Math.round(s*t)]}h8.defaultProps=h5,h8.layerName="TextLayer";var h7=e.i(55527),ue=e.i(9537);let ut=[[-129,13],[-64,55]],ui={top:90,bottom:100,left:30,right:30},ur="data:image/svg+xml;base64,"+btoa('<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><path d="M20 60h24V30a12 12 0 0 0-24 0z" fill="#6b7280"/><path d="M20 60h24V30a12 12 0 0 0-24 0z" fill="none" stroke="#2f3542" stroke-width="2"/><rect x="27" y="34" width="10" height="3" fill="#fff"/><rect x="30.5" y="30" width="3" height="14" fill="#fff"/></svg>'),un="data:image/svg+xml;base64,"+btoa('<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><circle cx="32" cy="32" r="29" fill="#fff" stroke="#14171F" stroke-width="3"/><path d="M23 14h18v10a9 9 0 0 1-18 0z" fill="#F5C451" stroke="#8A6A16" stroke-width="2.4" stroke-linejoin="round"/><path d="M23 17h-5v3a6.5 6.5 0 0 0 6.5 6.5M41 17h5v3a6.5 6.5 0 0 1-6.5 6.5" fill="none" stroke="#8A6A16" stroke-width="2.6" stroke-linecap="round"/><path d="M30 33h4v6h-4z" fill="#D9A62E"/><path d="M25 45h14l-1.5-6h-11z" fill="#F5C451" stroke="#8A6A16" stroke-width="2.2" stroke-linejoin="round"/><rect x="22" y="45" width="20" height="5" rx="2" fill="#D9A62E" stroke="#8A6A16" stroke-width="2.2"/></svg>'),us=(e,t,i)=>"data:image/svg+xml;base64,"+btoa(`<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><circle cx="32" cy="32" r="29" fill="#fff" stroke="#14171F" stroke-width="3"/><path d="M20 10h8l7 16h-8zM44 10h-8l-7 16h8z" fill="${t}"/><circle cx="32" cy="40" r="14" fill="${e}" stroke="${t}" stroke-width="2.4"/><text x="32" y="46" text-anchor="middle" font-family="Oswald,sans-serif" font-weight="700" font-size="17" fill="#fff">${i}</text></svg>`),uo={2:us("#B7BEC8","#7C8794","2"),3:us("#C6803E","#8A5526","3"),4:us("#AEB5C0","#6E7683","4")},ua="data:image/svg+xml;base64,"+btoa('<svg xmlns="http://www.w3.org/2000/svg" width="8" height="8"><rect width="8" height="8" fill="#fff"/></svg>'),ul=[[245,196,81],[86,204,242],[46,204,113],[255,107,107],[199,139,255],[242,153,74]],uc=Array.from({length:64},(e,t)=>{let i=43758.5453*Math.sin(12.9898*t),r=12345.6789*Math.sin(78.233*t),n=r-Math.floor(r);return{i:t,angle:-Math.PI/2+(i-Math.floor(i)-.5)*1.9,speed:20+32*n,phase:t/64,size:4+3.5*n,color:ul[t%ul.length]}});function uh(e,t,i,r,n){let s="";for(let o=0;o<2*i;o++){let a=o%2==0?r:n,l=Math.PI*o/i-Math.PI/2;s+=(0===o?"M":"L")+(e+Math.cos(l)*a).toFixed(1)+" "+(t+Math.sin(l)*a).toFixed(1)}return s+"Z"}let uu="data:image/svg+xml;base64,"+btoa(`<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100"><path d="${uh(50,50,12,48,26)}" fill="#F2994A"/><path d="${uh(50,50,12,34,15)}" fill="#F5C451"/><circle cx="50" cy="50" r="11" fill="#fff"/></svg>`),ud={version:8,sources:{na:{type:"geojson",data:(0,h7.asset)("/geo/na.geojson")}},layers:[{id:"bg",type:"background",paint:{"background-color":"#FFFFFF"}},{id:"na-fill",type:"fill",source:"na",paint:{"fill-color":["match",["get","code"],"USA","#E4EBFA","CAN","#FBE1E6","MEX","#E0F2E6","#EFEFEF"],"fill-opacity":.9}},{id:"na-line",type:"line",source:"na",paint:{"line-color":["match",["get","code"],"USA","#0A3EA1","CAN","#E4002B","MEX","#00843D","#B9BDC7"],"line-width":1.6}}]};function up(e){return $(()=>new a7({interleaved:!1})).setProps({layers:e.layers,getTooltip:e.getTooltip}),null}e.s(["default",0,function({tl:e,t,focus:i,onSelect:r}){let[n,s]=(0,_.useState)(!1);(0,_.useEffect)(()=>{let e=()=>s(window.innerWidth<600);return e(),window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)},[]);let o=(0,_.useMemo)(()=>{let s=(0,ue.teamMarkers)(e,t),o=i?e.flights.filter(e=>e.code===i):(0,ue.trailFlights)(e,t),a=(0,ue.activeClashes)(e,t).filter(e=>!i||e.a.code===i||e.b.code===i),l=(0,ue.graves)(e,t),c=(0,ue.explosions)(e,t),h=(0,ue.medals)(e,t).filter(e=>!i||e.code===i),u=(0,ue.champion)(e,t),d=u&&(!i||u.code===i)?u:null,p=new Map,f=new Map;for(let e of s){let t=`${e.pos[0].toFixed(2)},${e.pos[1].toFixed(2)}`;(f.get(t)??f.set(t,[]).get(t)).push(e)}for(let e of f.values()){let t=e.length;if(1===t){p.set(e[0].code,[0,0]);continue}let i=Math.max(14.399999999999999,20*t/(2*Math.PI));e.forEach((e,r)=>{let n=r/t*Math.PI*2-Math.PI/2;p.set(e.code,[Math.cos(n)*i,Math.sin(n)*i])})}let g=s.filter(e=>!e.flying&&!e.eliminated&&e.code!==d?.code&&(!i||e.code===i)),m=(n?9.5:12)+ +Math.sin(5*t);return[new hA({id:"stadiums",data:e.stadiums,getPosition:e=>e.coords,getRadius:5,radiusUnits:"pixels",getFillColor:[20,23,31,35],getLineColor:[20,23,31,190],stroked:!0,lineWidthMinPixels:1.5}),new h8({id:"stadium-labels",data:e.stadiums,getPosition:e=>e.coords,getText:e=>e.city,getSize:11,getColor:[20,23,31,210],getPixelOffset:[0,-13],fontFamily:"Oswald, sans-serif",fontWeight:600,characterSet:"auto",outlineColor:[255,255,255,255],outlineWidth:2,fontSettings:{sdf:!0}}),new hn({id:"trails",data:o,pickable:!0,greatCircle:!0,getHeight:ue.ARC_HEIGHT,getSourcePosition:e=>e.from,getTargetPosition:e=>e.to,getSourceColor:e=>{let[t,r,n]=h9(e.color);return i?[t,r,n,e.isReturn?130:255]:[t,r,n,e.isReturn?55:e.isKnockout?220:140]},getTargetColor:e=>{let[t,r,n]=h9(e.color);return i?[t,r,n,e.isReturn?130:255]:[t,r,n,e.isReturn?55:e.isKnockout?220:140]},getWidth:e=>i?e.isKnockout?4:e.isReturn?1.6:3:e.isKnockout?2.5:e.isReturn?.8:1.4,widthUnits:"pixels",updateTriggers:{getSourceColor:i,getTargetColor:i,getWidth:i}}),new hA({id:"clash-pulse",data:a,getPosition:e=>e.coords,getRadius:e=>8+(t-e.tMatch)*260,radiusUnits:"pixels",stroked:!0,filled:!1,getLineColor:e=>{let i=Math.max(0,230-(t-e.tMatch)*700);return e.isKnockout?[228,0,43,i]:[10,62,161,.8*i]},lineWidthMinPixels:2,updateTriggers:{getRadius:t,getLineColor:t}}),new hw({id:"flags",data:s,pickable:!0,onClick:e=>{e.object&&r(e.object.code)},getPosition:e=>[e.pos[0],e.pos[1],e.alt],getIcon:e=>({id:e.eliminated?`${e.iso}_g`:e.iso,url:(0,h7.asset)(`/flags/${e.iso}${e.eliminated?"_gray":""}.png`),width:128,height:128,mask:!1}),getSize:e=>{let t=e.flying?28:e.code===d?.code?26:20;return i&&e.code===i?1.3*t:t},getColor:e=>i&&e.code!==i?[255,255,255,70]:[255,255,255,255],getPixelOffset:e=>p.get(e.code)??[0,0],sizeUnits:"pixels",billboard:!0,updateTriggers:{getPosition:t,getIcon:t,getSize:[t,i],getColor:i,getPixelOffset:t}}),new hw({id:"resting",data:g,getPosition:e=>e.pos,getIcon:()=>({id:"sleep",url:(0,h7.asset)("/dormir.svg"),width:246,height:246,mask:!1}),getSize:m,getPixelOffset:e=>{let[i,r]=p.get(e.code)??[0,0];return[i+(n?8:10),r+(n?-10:-12)+1.2*Math.sin(12*t+e.code.charCodeAt(0))]},sizeUnits:"pixels",billboard:!0,updateTriggers:{getSize:[t,n],getPixelOffset:[t,i,n]}}),new hw({id:"explosions",data:c,getPosition:e=>e.elimCoords,getIcon:()=>({id:"boom",url:uu,width:100,height:100,mask:!1}),getSize:e=>14+46*Math.min(1,Math.max(0,(t-e.elimTime)/ue.EXPL_DUR)),getColor:e=>{let i=Math.min(1,Math.max(0,(t-e.elimTime)/ue.EXPL_DUR));return[255,255,255,Math.round(255*(1-i*i))]},sizeUnits:"pixels",billboard:!0,updateTriggers:{getSize:t,getColor:t}}),new hw({id:"graves",data:l,getPosition:e=>e.elimCoords,getIcon:()=>({id:"tomb",url:ur,width:64,height:64,mask:!1}),getSize:22,getPixelOffset:[16,-2],sizeUnits:"pixels"}),new hw({id:"medals",data:h,getPosition:e=>e.elimCoords,getIcon:e=>({id:`medal${e.podium}`,url:uo[e.podium],width:64,height:64,mask:!1}),getSize:22,getPixelOffset:e=>{let[t,i]=p.get(e.code)??[0,0];return[t+15,i-2]},sizeUnits:"pixels",billboard:!0,updateTriggers:{getPixelOffset:t}}),new hA({id:"champion-pulse",data:d?[d]:[],getPosition:e=>e.championCoords,getRadius:e=>10+70*((t-e.championTime)/.14%1),radiusUnits:"pixels",stroked:!0,filled:!1,getLineColor:e=>[245,196,81,Math.round(230*(1-(t-e.championTime)/.14%1))],lineWidthMinPixels:2.5,updateTriggers:{getRadius:t,getLineColor:t}}),new hw({id:"confetti",data:d?uc:[],getPosition:()=>d.championCoords,getIcon:()=>({id:"confetti",url:ua,width:8,height:8,mask:!0}),getColor:e=>{let i=((t-d.championTime)/.14+e.phase)%1;return[...e.color,Math.round(255*(1-i)**1.5)]},getSize:e=>e.size,getPixelOffset:e=>{let[i,r]=p.get(d.code)??[0,0],n=((t-d.championTime)/.14+e.phase)%1;return[i+Math.cos(e.angle)*e.speed*n,r+Math.sin(e.angle)*e.speed*n+85*n*n-40]},sizeUnits:"pixels",billboard:!0,updateTriggers:{getPosition:d?.code,getColor:t,getPixelOffset:t}}),new hw({id:"champion",data:d?[d]:[],getPosition:e=>e.championCoords,getIcon:()=>({id:"trophy",url:un,width:64,height:64,mask:!1}),getSize:30+2.5*Math.sin(9*t),getPixelOffset:e=>{let[t,i]=p.get(e.code)??[0,0];return[t,i-46]},sizeUnits:"pixels",billboard:!0,updateTriggers:{getSize:t,getPixelOffset:t}})]},[e,t,i,r,n]),a=(0,_.useRef)(null),l=(0,_.useCallback)((e=!1)=>{a.current?.getMap().fitBounds(ut,{padding:ui,animate:!e,duration:400})},[]);(0,_.useEffect)(()=>{let e=0,t=()=>{cancelAnimationFrame(e),e=requestAnimationFrame(()=>l(!0))};return window.addEventListener("resize",t),window.addEventListener("orientationchange",t),()=>{window.removeEventListener("resize",t),window.removeEventListener("orientationchange",t),cancelAnimationFrame(e)}},[l]);let c=(0,_.useCallback)(t=>{let i=t.object,r=t.layer?.id;if(!i?.code)return null;let n=e.teams[i.code]?.name??i.code,s={background:"#fff",color:"#14171F",border:"2px solid #14171F",borderRadius:"4px",fontFamily:"Oswald, sans-serif",fontSize:"12px",padding:"6px 9px",boxShadow:"3px 3px 0 rgba(20,23,31,0.18)"};return"trails"===r?{html:`<b>${n}</b><br/>${i.fromCity} → ${i.toCity}`,style:s}:"flags"===r?{html:`<b>${n}</b>`,style:s}:null},[e]);return(0,v.jsx)(j,{ref:a,initialViewState:{longitude:-100,latitude:37,zoom:3.1},onLoad:()=>l(!0),style:{position:"absolute",inset:0,width:"100%",height:"100%"},mapStyle:ud,maxBounds:[[-150,6],[-45,66]],attributionControl:!1,children:(0,v.jsx)(up,{layers:o,getTooltip:c})})}],35277)},14200,e=>{e.n(e.i(35277))}]);